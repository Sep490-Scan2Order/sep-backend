...
namespace ScanToOrder.Application.Interfaces
{
    public interface IRestaurantService
    {
        ...
        Task<PagedRestaurantResultDto> GetRestaurantsPagedAsync(double? latitude, double? longitude, int page = 1, int pageSize = 20, string? keyword = null);
        ...
        Task<string> UpdateOpeningStatusAsync(int restaurantId, bool isOpened);
        Task<string> UpdateActiveStatusAsync(int restaurantId, bool isActive);
