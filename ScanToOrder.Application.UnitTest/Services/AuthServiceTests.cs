...
public class AuthServiceTests
{
    ...
    [Fact]
    public void StaffDto_Properties_GetAndSetCorrectly()
    {
        // Arrange
        var id = Guid.NewGuid();
    ...
    [Fact]
    public void TenantDto_Properties_GetAndSetCorrectly()
    {
        // Arrange
        var id = Guid.NewGuid();
        var accountId = Guid.NewGuid();
        ...
        dto.CardNumber.Should().Be("CARD123");
        dto.IsVerifyBank.Should().BeTrue();
        dto.IsVerifyTax.Should().BeTrue();
        dto.DebtStartedAt.Should().Be(date);
        dto.SubscriptionExpiryDate.Should().Be(date);
        dto.LastWarningSentAt.Should().Be(date);
        dto.TotalDebtAmount.Should().Be(1000m);
        dto.IsSuspended.Should().BeTrue();
        dto.SuspendedAt.Should().Be(date);
    }
    #endregion
}