...
namespace ScanToOrder.Application.UnitTest.Services
{
    public class MenuTemplateServiceTests
    {
        ...
        [Fact]
        public void DTOs_Properties_GetAndSetCorrectly()
        {
            var createReq = new CreateTemplateRequestDto
            {
                TemplateName = "A",
                ThemeColor = "B",
                FontFamily = "C",
            ...
            var createRes = new CreateTemplateResponseDto
            {
                Id = 1,
                TemplateName = "A",
                ThemeColor = "B",
            ...
            var menuTemplateDto = new MenuTemplateDto
            {
                Id = 1,
                TemplateName = "A",
                ThemeColor = "B",
            ...
            var updateReq = new UpdateMenuTemplateDto
            {
                TemplateName = "A",
                ThemeColor = "B",
                FontFamily = "C",
            ...
            var renderDto = new MenuTemplateRenderDto
            {
                TemplateId = 1,
                RestaurantId = 1,
                ThemeColor = "B",
                FontFamily = "C",
                LayoutConfigJson = "E",
                MenuData = new List<MenuCategoryDto>()
            };
            var aiReq = new AiHolidayTemplateRequestDto { HolidayName = "Tet" };
            var aiRes = new AiHolidayTemplateResponseDto
            {
                TemplateName = "A",
                ThemeColor = "B",
                FontFamily = "C",
            ...
            createReq.TemplateName.Should().Be("A");
            createRes.Id.Should().Be(1);
            menuTemplateDto.Id.Should().Be(1);
            updateReq.TemplateName.Should().Be("A");
